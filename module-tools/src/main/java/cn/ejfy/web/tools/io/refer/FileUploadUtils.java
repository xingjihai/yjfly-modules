...
// */
//package cn.ejfy.web.tools.io.refer;
//
//import java.io.File;
...
//import com.notary.framework.common.util.StringUtil;
//import com.notary.framework.utils.LogUtils;
//import com.notary.framework.utils.StaticResourcesUtil;
//import com.notary.framework.utils.security.Md5Utils;
//import com.notary.framework.utils.upload.exception.FileNameLengthLimitExceededException;
//import com.notary.framework.utils.upload.exception.InvalidExtensionException;
//
///**
// * 文件上传工具类
// * <p>User: Zhang Kaitao
...
//    }
//    public static final String upload(HttpServletRequest request,String baseDir, MultipartFile file, BindingResult result) {
//    	try {
//        	return upload(request, getDefaultBaseDir(), file, DEFAULT_ALLOWED_EXTENSION, DEFAULT_MAX_SIZE, true, null);
//        } catch (IOException e) {
...
//            String[] allowedExtension, long maxSize, boolean needDatePathAndRandomName,String customFileName)
...
//        String filename = extractFilename(file, baseDir, needDatePathAndRandomName, customFileName);
//
...
//
//
//    public static final String extractFilename(MultipartFile file, String baseDir, boolean needDatePathAndRandomName, String customFileName)
...
//        }else if(Strings.isNullOrEmpty(customFileName)) {
//            filename = baseDir + File.separator + filename;
//        }else {
//            filename = baseDir + File.separator + customFileName;
//        }
//
//        return filename;
//    }
...
//		filename2 = Md5Utils.hash(filename + System.nanoTime() + counter++);
//		filename2 += (!StringUtil.isBlank(extension)) ? "." + extension : "";
//        return filename2;
//    }
//
//    /**
...
//    	return StaticResourcesUtil.getStatic_server_path();
////        return request.getRealPath("/");
//    }
//
//    public static void copyFile(InputStream in, String filePath) {
...
//     * @return 随机文件名
//     */
//	public static final String generateRandomFileName(String originalFileName) {
//		return UUID.randomUUID().toString() + "." + Files.getFileExtension(originalFileName);
//		// return IdGenerator.uuid()+ "."+Files.getFileExtension(originalFileName);
//	}
//
//}
